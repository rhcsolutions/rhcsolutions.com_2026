...
const offices: Office[] = [
  { city: 'New York', country: 'USA', coordinates: { x: 25, y: 40 }, timezone: 'EST' },
  { city: 'Lisbon', country: 'Portugal', coordinates: { x: 45, y: 42 }, timezone: 'WET' },
  { city: 'Sofia', country: 'Bulgaria', coordinates: { x: 55, y: 38 }, timezone: 'EET' },
  { city: 'Tel Aviv', country: 'Israel', coordinates: { x: 58, y: 48 }, timezone: 'IST' },
  { city: 'Larnaca', country: 'Cyprus', coordinates: { x: 57, y: 46 }, timezone: 'EET' },
];
